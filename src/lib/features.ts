...
export const FEATURES: Record<FeatureSlug, Feature> = {
  scheduling: {
    ...
    bullets: [
      ...
      "Ramp-out → ramp-in with Hobbs, tach, and fuel — then an invoice draft",
  ...
  "self-booking": {
    ...
    bullets: [
      ...
      "Checkout gating — only approved people fly each tail",
  ...
  integrations: {
    ...
    summary:
      "Stripe payments run today. Google Calendar and QuickBooks are next — shipped to every plan, not locked behind enterprise.",
    bullets: [
