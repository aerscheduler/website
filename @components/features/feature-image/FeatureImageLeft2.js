    ...
    return (
        <div className="row align-items-center">
            ...
            <div className="col-lg-5 col-md-6 ms-lg-auto">
                <h2 className='position-relative fs-1 mb-4' data-aos="fade-up">You just sign up and join.</h2>
                <p className='lead d-none d-lg-block mb-4' data-aos="fade-up" data-aos-delay="100">After you create an account, you can simply create an organization or join an existing one!</p>
                <ul className='list-unstyled mb-5' data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ListCheck className="d-flex mb-3 align-items-start" listText="You can also assign students to instructors and restrict who can fly with who." />
                </ul>
                <div data-aos="fade-up" data-aos-delay="300">
                    <Link href='/#'><a className='fw-bold'>Learn More About Our App
