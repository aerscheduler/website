    ...
    <div className="row align-items-center">
      ...
      <div className="col-md-6 col-lg-9 mx-auto">
        <h2 className="position-relative fs-1 mb-4" data-aos="fade-up">
          Add maintenance reminders and track squawks.
        </h2>
        <p className="lead d-lg-block mb-4" data-aos="fade-up" data-aos-delay="100">
          {" "}
          Create maintenance templates that can be applied to any aircraft. When maintenance is approaching, technicians and administrators receive a notification.
        </p>
        <ul className="list-unstyled mb-5" data-aos="fade-up" data-aos-delay="200">
          <ListCheck className="d-flex mb-3 align-items-start" listText="Set day-based, hour-based, and date maintenance reminders" />
          <ListCheck className="d-flex mb-3 align-items-start" listText="After planes are ramped in, the option to report any squawks will come up." />
          <ListCheck className="d-flex mb-3 align-items-start" listText="Verify and resolve any squawks" />
        </ul>
