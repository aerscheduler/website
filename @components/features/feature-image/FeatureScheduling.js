    ...
    <div className="row align-items-center">
      ...
      <div className="col-md-6 col-lg-9 mx-auto">
        ...
        <p className="lead d-lg-block mb-4" data-aos="fade-up" data-aos-delay="100">
          Use our smart scheduler to book aircrafts, instructors, and students. Our app will automatically check for conflicts and notify pilots when reservations are created, updated, or cancelled.
        </p>
        <ul className="list-unstyled mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <ListCheck className="d-flex mb-3 align-items-start" listText="Only view the reservations you want to see by setting filters and favorites" />
          <ListCheck className="d-flex mb-3 align-items-start" listText="Book your students, instructors, renters, and guests." />
          <ListCheck className="d-flex mb-3 align-items-start" listText="Google calendar integration." />
        </ul>
