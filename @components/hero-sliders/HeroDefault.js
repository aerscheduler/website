          ...
          <div className="col-lg-6 col-md-10 mx-auto mx-lg-0 position-relative">
            <div className="position-relative w-100 p-3 p-lg-5">
              ...
              <div className="bg-white rotate-4 shadow-lg position-absolute end-0 top-0 width-240 h-auto text-dark rounded-4 p-3">
                <FeatureIconTiny icon={<span className="material-symbols-rounded align-middle fs-3">workspaces</span>} color="warning" text="Easy scheduling" />
              </div>
              {/**Feature Icon */}
              <div className="bg-white rotate-n4 shadow-lg position-absolute start-0 bottom-0 width-220 h-auto text-dark rounded-4 p-3">
                <FeatureIconTiny icon={<span className="material-symbols-rounded align-middle fs-3">task</span>} color="primary" text="Manage your flight program" />
              </div>
            </div>
          </div>
        </div>
