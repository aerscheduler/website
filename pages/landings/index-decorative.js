...
export default function IndexDecorative() {
  return (
    <>
      <Head>
        <title>AerScheduler - Home 3</title>
      </Head>
      <HeroDecorative />
        ...
        <div className="container py-9 py-lg-11 position-relative z-index-1">
          <div className="mb-6 mb-lg-9 mx-auto text-center w-lg-50">
            ...
            <h2 className="display-5" data-aos="fade-up">
              See what AerScheduler can do for your organization.
            </h2>
          </div>
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-sm-6 col-xl-3 mb-6" data-aos="fade-up">
              <FeatureIconWithTitle
                ...
                color="warning"
                title="Fast"
                description="No more scrambling to a computer. Pull our your phone, do everything fast."
              />
            </div>
            ...
            <div className="col-sm-6 col-xl-3 mb-6 mb-md-0" data-aos="fade-up">
              <FeatureIconWithTitle
                ...
                description="We have systems in place to backup your data and make sure we are up and running over 99.9% of the time."
              />
            </div>
            <div className="col-sm-6 col-xl-3 mb-6 mb-sm-0" data-aos="fade-up">
              <FeatureIconWithTitle
                ...
                color="secondary"
                title="Affordable"
                description="Our scheduling feature is completely free to use and we don't plan on changing that. However, we do plan on releasing premium features."
              />
            </div>
            <div className="col-sm-6 col-xl-3" data-aos="fade-up">
              <FeatureIconWithTitle
                ...
                description="We see the potential here. We are actively adding new features, fixing bugs, and doing maintenance."
              />
            </div>
          </div>
        </div>
      ...
      <section className="bg-style-1">
        <div className="container py-9 py-lg-11">
          <CtaVertical
            ...
            heading="Kickstart your aviation program with free scheduling"
