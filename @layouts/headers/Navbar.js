        ...
        <>
            <ul className="me-auto navbar-nav ms-xl-4">
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu">
                  <ActiveLink activeClassName="active" href="/landings"><a className="dropdown-item">Default</a></ActiveLink>
                  <ActiveLink activeClassName="active" href="/landings/index-signup"><a className="dropdown-item">SignUp</a></ActiveLink>
                  <ActiveLink activeClassName="active" href="/landings/index-decorative"><a className="dropdown-item">Decorative</a></ActiveLink>
              ...
              <li className="nav-item">
                <ActiveLink href="/pricing" activeClassName="active"><a className="nav-link">Pricing</a></ActiveLink>
              </li>
              <li className="nav-item">
                <ActiveLink href="/integrations" activeClassName="active"><a className="nav-link">integrations</a></ActiveLink>
              </li>
              <li className="nav-item">
            ...
            <ul className="navbar-nav ms-xl-auto">
              <li className="nav-item dropdown mb-3 mb-lg-0">
                ...
                <ActiveLink activeClassName="active" href="/more/customers"><a className="dropdown-item">Customers</a></ActiveLink>
                <ActiveLink activeClassName="active" href="/more/typography"><a className="dropdown-item">Typography</a></ActiveLink>
                <ActiveLink activeClassName="active" href="/404"><a className="dropdown-item">Custom 404</a></ActiveLink>
                <ActiveLink activeClassName="active" href="/demo-request"><a className="dropdown-item">Demo request</a></ActiveLink>
                <ActiveLink activeClassName="active" href="/auth/signin"><a className="dropdown-item">Sign In</a></ActiveLink>
                <ActiveLink activeClassName="active" href="/auth/signup"><a className="dropdown-item">Sign Up</a></ActiveLink>
                <ActiveLink activeClassName="active" href="/auth/forgot-password"><a className="dropdown-item">Forget password</a></ActiveLink>
                 </div>
              </li>
              <li className="nav-item mb-3 mb-lg-0">
                <ActiveLink activeClassName="active" href="/demo-request"><a className="btn btn-warning btn-sm hover-lift">Request Demo
                <span className="align-middle material-symbols-rounded fs-5 ms-1 d-none d-xl-inline-block">arrow_forward</span>
                </a></ActiveLink>
              </li>
              <li className="nav-item">
                <ActiveLink activeClassName="active" href="/auth/signin"><a className="nav-link">Sign In</a></ActiveLink>
              </li>
